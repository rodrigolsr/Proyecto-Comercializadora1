  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
      ...
      <div class="w3-section w3-bottombar w3-padding-16">
        ...
        <button class="w3-button w3-green w3-margin" onclick="mostrarFormulario()">Registrar Producto</button>
        <button class="w3-button w3-red w3-margin" onclick="recargarPagina()">Actualización Productos del Catálogo </button>
      </div>
    </div>
  </header>
...
<!--Sección del catálogo general !-->
    ...
    <table class="w3-table w3-bordered">
        ...
        <?php
            ...
            while ($fila = $consulta->fetch_assoc()) {
                ...
                echo "<td>
                        <a href='#' onclick='mostrarFormularioEditar({$fila['id']})'>Editar</a>|
  ...
  <!-- Images of Me -->
  <div class="w3-row-padding w3-padding-16" id="#Sabout">
    <div class="w3-col m6">
...
<script>
  function mostrarFormulario() {
      ...
      var modal = window.open('agregar.php', 'Registrar Producto', 'width=500,height=900');
  }

  function mostrarFormularioEditar(id) {
      // Cargar el contenido de agregar.php en una ventana emergente
      var modal = window.open('editar.php?id=' + id, 'Editar Producto', 'width=500,height=900');
  }

  function mostrarMensajeEliminado(id) {
      // Cargar el contenido de eliminar.php en una ventana emergente al eliminar un registro
      var modal = window.open('eliminar.php?id=' + id, 'Eliminar Producto', 'width=500,height=300');
  }
  ...
  function confirmarEliminacion(id) {
        ...
        if (confirmacion) {
            // Si el usuario confirma, ejecutar la acción de eliminación
            mostrarMensajeEliminado(id);
        } else {
            // Si el usuario cancela, no hacer nada o puedes agregar algún código adicional si lo necesitas
        }
    }
  function recargarPagina() {
    location.reload(true); // La función reload(true) fuerza una recarga desde el servidor
}
